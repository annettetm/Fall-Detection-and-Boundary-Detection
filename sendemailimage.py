...
def send_email(filename,receiver_email, subject='FALL ALERT!!!!!', alert_message='Please take immediate action!', detection_time=datetime.now().strftime('%Y-%m-%d %H:%M:%S')):
...
if __name__ =="__main__":
    ...
    receiver_email=''
    subject = 'Fall Alert'
    alert_message = 'A fall has occurred. Please take immediate action!'
